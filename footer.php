...
<div id="barrafootermaster" style="display:none">
  <div id="barrafootermastermeio">
      <li>Precisando de ajuda ? <img src="<?php echo get_template_directory_uri (); ?>/images/tel-faixafooter.jpg" alt="telefone" /> Ligue agora: <strong>0800 014 2001</strong></li>
       <li class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalchatonline"><img src="<?php echo get_template_directory_uri (); ?>/images/icone-footer-assistente.png" alt="atendimento-online" />Assistente virtual</li>
      ...
      <li id="modal_agenda_visita" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modalagendavisita"><img src="<?php echo get_template_directory_uri (); ?>/images/icone-footer-dois.png" alt="agende-visitas" />Agende uma<br/>Visita</li>
       ...
       <li  class="btn-info btn-lg whatsapp" ><img src="<?php echo get_template_directory_uri (); ?>/images/icone-footer-quatro.png" alt="whatsapp" />Whatsapp: <span>97616.3764</span></li>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header header-assistente">
       ...
       <img src="<?php echo get_template_directory_uri (); ?>/images/icone-footer-assistente.png" alt="chat-online" /> <h4 class="modal-title">Bem-vindo ao Chat</h4>
      </div>
