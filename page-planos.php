...
<h2 class="title-default">Escolha o plano ideal para você</h2>
</div>


<div class="row">

  <img class="imgplanos" src="http://telehelp.com.br/wp-content/themes/telehelp/images/image-page-planos2016_03.jpg" alt="Planos">
  <div id="textoplanotelehelp">
    ...
    <a href="#" class="animated2 hover75 botaoplanos">ASSINE AGORA <i class="glyphicon glyphicon-chevron-right"></i></a>
  </div>
