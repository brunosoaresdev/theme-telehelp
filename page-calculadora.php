...
<head>
    ...
    <style>
        ...
        .calculator-pattern {
            background-image: url(<?php echo get_template_directory_uri(); ?>/images/calculadora-pattern.png);
            background-repeat: repeat;
        }
        .calculator-wrapper {
            background-image: url(<?php echo get_template_directory_uri(); ?>/images/calculadora-people.jpg);
        ...
        <div id="terceirotitulo">
            <div class="container">
                <h3 class="title-default">
                    ...
                    <img style="margin-top: 30px; float: right;" src="http://telehelp.com.br/wp-content/themes/telehelp/images/assine-agora.png" alt="TeleHelp" title="TeleHelp">
                </h3>
            </div>
        </div>
    </div>
                                        ...
                                        <div id="camposefordeavaliacao">
                                            ...
                                            <form id="msform" method="post" action="javascript:void(0)">
                                                ...
                                                <div style="text-align: center;">
                                                    <input type="button" name="next" onclick="go_step(inicial-1)" class="next action-button" id="btn_passoprev" value="< VOLTAR" /><input type="button" name="next" onclick="resultados(event,inicial+1)" class="next action-button" id="btn_passonext" value="PRÓXIMA >" />
                                                    <input type="button" name="next" onclick="resultados(event,6)" class="next action-button" id="btn_passofim" value="FINALIZAR" />
                                                </div>
