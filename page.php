    ...
    <div class="row">
      <div class="col-md-6">
       ...
       <div id="quadroslinhadois"  data-animation-type="fadeInDown" data-animation-duration="1" data-animation-delay="0.8">
         <img src="<?php echo get_template_directory_uri (); ?>/images/dentro-de-casa.jpg" alt="dentro-casa">
       </div>
     </div>
     <div class="col-md-6">
       ...
       <div id="quadroslinhadois"  data-animation-type="fadeInDown" data-animation-duration="1" data-animation-delay="0.11">
         <img src="<?php echo get_template_directory_uri (); ?>/images/fora-de-casa.jpg" alt="fora-casa">
       </div>
     </div>
   </div>
 </div>
