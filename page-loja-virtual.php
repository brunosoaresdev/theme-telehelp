...
<h1>
Escolha o plano ideal para vocę
</h1>
</div>
...
<a href="" class="disponibilidade">** Sujeito a disponibilidade do serviço na cidade. Consultar Cidade</a>
...
<div class="row">
  ...
  <div class="col-md-4" id="corpovaloreservicosmodal">
	<div id="corpovaloreservicosmodalli">
        <li><i class="glyphicon glyphicon-ok"></i> Painel de emergęncia com viva voz</li>
        ...
        <li><i class="glyphicon glyphicon-ok"></i> Ligaçăo semanal</li>
        <li><i class="glyphicon glyphicon-ok"></i> Orientaçăo médica via telefone</li>
        <?php
        if ($_SESSION["C_TLHPA"]):
        ?>
  ...
  <div id="precosdecadaplano-modal">
            ...
            +
            <strong>R$ 135,00 <i>/męs</i></strong>
