...
<div id="linha_2" style="display:none" class="row row_passos_conteudo"> 
	<div class="container"> 
		...
		<div class="col-md-5">
			<h1>Endereço onde o serviço será instalado</h1>
			...
			<input type="hidden" name="user" value="<?php echo (isset($_SESSION['s_user']) ? $_SESSION['s_user'] : "")?>">
			
			<div class="form-group">
			<label >Nome do Destinatário:</label>
			<input type="text" class="form-control modal-input" onkeypress="return sem_acento(event);" id="form-enome" name="form-enome" placeholder="" data-msg="Campo obrigatório">
			</div>
			<div class="form-group">
			<div class="col-50">
				<label >CEP:</label>
			...
			<div class="form-group"> 
			<label >Cidade:</label>
			<input type="text" class="form-control" id="form-ecid" onkeypress="return sem_acento(event);" name="form-ecid" placeholder="" data-msg="Campo obrigatório">
			</div>
			<div class="form-group">
			<label >Estados:</label>
...
<div class="row">
  <div class="col-md-4">
  	<div id="opscoesdepagamento">
    	<h2>Opções de Pagamento <strong><!-- Área texto Desconto quando houver --></strong></h2>
        
        	<div class="row">
              <div class="col-md-4">Á VISTA</div>
              <div class="col-md-4">R$ <?php echo (number_format((($totalgeral+$totalad)*1),2,".",",")) ?></div>
              <div class="col-md-4"></div>
            </div>
            
           <div class="row">
              <div class="col-md-4">EM 3X</div>
              <div class="col-md-4">3x de R$ <?php echo (number_format(((($totalgeral+$totalad)*1)/3),2,".",",")) ?></div>
              <div class="col-md-4"></div>
            </div>
...
<div class="tab-content">
    ...
    <form id="pagseguro_form" action="javascript:void(0)">
									...
									<input type="hidden" name="valornormal7" value="<?php echo (number_format((($totalgeral+$totalad)*1),2,".","")) ?>">
									<input type="hidden" name="valornormal25" value="<?php echo (number_format((($totalgeral+$totalad)*1),2,".","")) ?>">
                                    ...
                                    <input type="hidden" name="cupom" value="<?php echo $dd;?>" id="cupom">
    	...
    	<li>
											<div class="pagcol-50">
												...
												<input type="text" name="titular" onkeypress="return sem_acento(event);" id="titular" class="inputcartao"  />
											</div>
											<div class="pagcol-50">
...
<div class="selector col30">
    ...
    <a id="btn-finalizar-pedido" onclick="finalizar_pedido()" class="" data-animation-type="fadeInDown" data-animation-duration="1">FINALIZAR COMPRA <i class="glyphicon glyphicon-chevron-right"></i> </a>
    	
    <div class="checkbox checkbox-inline">
            			<label>
										<input id="form_termos" name="form_termos" type="checkbox"> Li e aceito os <a href="#" data-toggle="modal" data-target="#modaltermos" >termos do contrato</a>
										</label>
        			</div> 
...
<div id="titulocontatodeemergencia">Em caso de emergência, para quem devemos ligar?</div>
<div class="row">
<form method="post" id="cadastro_emergencia" action="javascript:void(0)">
	<input type="hidden" name="acao" value="cadastra_emergencia">
	<input type="hidden" name="idpedido" id="idpedido" value="">
	<div id="error-cadastro" style="" class="col-md-12">
		<span class="modal-input-error" style="color:red;">Por favor preencha os campos marcados!</span>
	</div>
  <div class="col-md-4">
    ...
    <li>
    <label>Nome:</label>
    <input class="input_ce" onkeypress="return sem_acento(event);" type="text" id="c_nome1" name="nome[]" />
    </li>
    
    <li>
    <label>E-mail:</label>
    <input class="input_ce" type="text" id="c_email1" name="email[]" />
    </li>
    
    
    <li>
    <label>Telefone 1:</label>
    <input class="input_ce telfone" type="text" id="c_tel11" name="tel1[]" />
    </li>
    
    
    <li>
    <label>Telefone 2:</label>
    <input class="input_ce telfone" type="text" id="c_tel12" name="tel2[]" />
    </li>
    
    
    <li>
    <label>Telefone 3:</label>
    <input class="input_ce telfone" type="text" id="c_tel13" name="tel3[]" />
    </li>
    
    
    <li>
    <label>Grau de Parentesco:</label>
    <input class="input_ce" type="text" id="c_par1" name="par[]" />
    </li>
 </div>
  ...
  <div class="col-md-4">
    ...
    <li>
    <label>Nome:</label>
    <input class="input_ce" onkeypress="return sem_acento(event);" type="text" id="c_nome2" name="nome[]" />
    </li>
    
    <li>
    <label>E-mail:</label>
    <input class="input_ce" type="text" id="c_email2" name="email[]" />
    </li>
    
    
    <li>
    <label>Telefone 1:</label>
    <input class="input_ce telfone" type="text" id="c_tel21" name="tel1[]" />
    </li>
    
    
    <li>
    <label>Telefone 2:</label>
    <input class="input_ce telfone" type="text" id="c_tel22" name="tel2[]" />
    </li>
    
    
    <li>
    <label>Telefone 3:</label>
    <input class="input_ce telfone" type="text" id="c_tel23" name="tel3[]" />
    </li>
    
    
    <li>
    <label>Grau de Parentesco:</label>
    <input class="input_ce" type="text" id="c_par2" name="par[]" />
    </li>
  ...
  <div class="col-md-4">
    ...
    <li>
    <label>Nome:</label>
    <input class="input_ce" onkeypress="return sem_acento(event);" type="text" id="c_nome3" name="nome[]" />
    </li>
    
    <li>
    <label>E-mail:</label>
    <input class="input_ce" type="text" id="c_email3" name="email[]" />
    </li>
    
    
    <li>
    <label>Telefone 1:</label>
    <input class="input_ce telfone" type="text" id="c_tel31" name="tel1[]" />
    </li>
    
    
    <li>
    <label>Telefone 2:</label>
    <input class="input_ce telfone" type="text" id="c_tel32" name="tel2[]" />
    </li>
    
    
    <li>
    <label>Telefone 3:</label>
    <input class="input_ce telfone" type="text" id="c_tel33" name="tel3[]" />
    </li>
    
    
    <li>
    <label>Grau de Parentesco:</label>
    <input class="input_ce" type="text" id="c_par3" name="par[]" />
    </li>
  ...
  <div class="col-md-4">
   ...
   <li>
    <label>Nome:</label>
    <input class="input_ce" onkeypress="return sem_acento(event);" type="text" id="c_nome4" name="nome[]" />
    </li>
    
    <li>
    <label>E-mail:</label>
    <input class="input_ce" type="text" id="c_email4" name="email[]" />
    </li>
    
    
    <li>
    <label>Telefone 1:</label>
    <input class="input_ce telfone" type="text" id="c_tel41" name="tel1[]" />
    </li>
    
    
    <li>
    <label>Telefone 2:</label>
    <input class="input_ce telfone" type="text" id="c_tel42" name="tel2[]" />
    </li>
    
    
    <li>
    <label>Telefone 3:</label>
    <input class="input_ce telfone" type="text" id="c_tel43" name="tel3[]" />
    </li>
    
    
    <li>
    <label>Grau de Parentesco:</label>
    <input class="input_ce" type="text" id="c_par4" name="par[]" />
    </li>
  ...
  <div class="col-md-4">
    ...
    <li>
    <label>Nome:</label>
    <input class="input_ce" onkeypress="return sem_acento(event);" type="text" id="c_nome5" name="nome[]" />
    </li>
    
    <li>
    <label>E-mail:</label>
    <input class="input_ce" type="text" id="c_email5" name="email[]" />
    </li>
    
    
    <li>
    <label>Telefone 1:</label>
    <input class="input_ce telfone" type="text" id="c_tel51" name="tel1[]" />
    </li>
    
    
    <li>
    <label>Telefone 2:</label>
    <input class="input_ce telfone" type="text" id="c_tel52" name="tel2[]" />
    </li>
    
    
    <li>
    <label>Telefone 3:</label>
    <input class="input_ce telfone" type="text" id="c_tel53" name="tel3[]" />
    </li>
    
    
    <li>
    <label>Grau de Parentesco:</label>
    <input class="input_ce" type="text" id="c_par5" name="par[]" />
    </li>
  
  <div id="botaocontatodeemergencia">
  <button class="full-width btn-medium" onclick="cadastra_emergencia(event)" type="button" >CADASTRAR</button>
  </div>
  </form>
	...
	<div class="col-md-5 col-md-offset-1">
		<div id="pedidos-cadastro-form" class="col-md-12">
			...
			<div class="login-social">
					<a href="#" onclick="modalsface('loginBtnmee','cadastro')" id="loginBtncad" class="btn btn-primary"><i class="soap-icon-facebook"></i><span>Acesse Com <strong>Facebook</strong></span></a>
			</div>
			...
			<input type="text" class="form-control" onkeypress="return sem_acento(event);" id="form-nome" name="form-nome" placeholder="Digite seu nome" data-msg="Campo obrigatório">
			</div>
			<div class="form-group">
			<label >E-mail:</label>
			...
			<input type="text" class="form-control telefone" id="form-telefone" name="form-telefone" placeholder="(  ) _____-____" data-msg="Campo obrigatório">
			</div>
			<div class="form-group">
...
<input type="hidden" name="nome" id="modentnome" value="">
<input type="hidden" name="email" id="modentemail" value="">
<input type="hidden" name="user" value="<?php echo (isset($_SESSION['s_user']) ? $_SESSION['s_user'] : "")?>">
...
<li id="nomedestinatario">
<label>Nome Destinatário:</label>
<input style="width: 100%;" class="modal_e" id="form-nomec" name="form-nomec" type="text" name=""data-msg="" />
</li>
...
<label>Cidade:</label>
<input class="modal_e" id="form-mecid" onkeypress="return sem_acento(event);" name="form-mecid" type="text" name="" data-msg="" />
</li>
...
<input type="hidden" name="nome" id="modcobnome" value="">
<input type="hidden" name="form-nomec" value="">
<input type="hidden" name="email" id="modcobemail" value="">
<input type="hidden" name="user" value="<?php echo (isset($_SESSION['s_user']) ? $_SESSION['s_user'] : "")?>">
...
<li id="cidadeendereco">
<label>Cidade:</label>
<input class="modal_c" id="form-mccid"  onkeypress="return sem_acento(event);" name="form-mecid" type="text" name="" data-msg="" />
</li>
...
#form-cadastro-modal-entrega .help-block {
    font-size: 17px;
    height: 1px;
    display: none !important;
}
...
<!-- Google Code for Assine Online - Landing Page Conversion Page -->
...
var google_conversion_label = "9mKWCKTwuVYQyuHYzgM";
...
<img height="1" width="1" style="border-style:none;" alt="" src="//www.googleadservices.com/pagead/conversion/970338506/?label=9mKWCKTwuVYQyuHYzgM&amp;guid=ON&amp;script=0"/>
</div>
</noscript>
